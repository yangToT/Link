...
$references = @('System.dll','System.Core.dll','System.IO.Compression.dll','System.IO.Compression.FileSystem.dll','System.Management.dll','System.Security.dll','System.Web.Extensions.dll','System.ServiceProcess.dll','System.Drawing.dll','System.Windows.Forms.dll','System.Xaml.dll','WPF\WindowsBase.dll','WPF\PresentationFramework.dll','WPF\PresentationCore.dll')
...
$arguments += Join-Path $project 'deploy\ProgressWindow.cs'
