...
$references = @('System.dll','System.Core.dll','System.Security.dll','System.Web.Extensions.dll','System.ServiceProcess.dll','System.Xaml.dll','WPF\WindowsBase.dll','WPF\PresentationFramework.dll','WPF\PresentationCore.dll')
